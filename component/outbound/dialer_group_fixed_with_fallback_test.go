...
func (m *mockDialer) Property() *dialer.Property {
	// Name is a promoted field of the embedded D.Property and cannot be set
	// directly in a dialer.Property struct literal; the mock does not rely on it.
	return &dialer.Property{}
}
